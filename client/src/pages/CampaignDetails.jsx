...
import { calculateBarPercentage, daysLeft, deadDate } from "../utils";
import { profile, favicon2 } from "../assets";
...
const CampaignDetails = () => {
  ...
  const [day, setday] = useState("End Date");
  ...
  return (
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap  justify-between gap-[30px]">
          <CountBox
            title={day}
            value={
              <div className="text-lg">{deadDate(state.deadline, "/")}</div>
            }
          />
          <CountBox
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        {state.owner !== address && remainingDays >= 0 && (
          <div className="flex-1">
            ...
            <div className="mt-[20px] flex flex-col p-4 bg-white rounded-[10px]">
              ...
              <div className="mt-[30px]">
                ...
                <div className="my-[20px] p-4 bg-zinc-300 rounded-[10px]">
