...
const CreateCampaign = () => {
  ...
  return (
    <div className="bg-white flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      {isLoading && <Loader />}
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-slate-100 rounded-[10px]">
      ...
      >
        ...
        <div className="w-full flex justify-center items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]">
          ...
          />
          <h4 className="font-epilogue font-bold text-[25px] text-white text-center ml-[20px]">
            100% of the amount will be credited
          </h4>
        </div>
